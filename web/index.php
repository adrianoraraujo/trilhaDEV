...
<header class="w3-container w3-center w3-padding-32"> 
  <h1><b>TRILHA DEV - Simulador WebCode</b></h1>
  


  <p>TRILHA DEV <span class="w3-tag">TRILHA DEV</span></p>
</header>
...
<a  class="alignleft"><img src="trilha.jpg" alt="" width=60 height=38 ></a>
<a href="javascript:void(0);" onclick="restack(currentStack)" title="Girar a tela" class="w3-bar-item w3-button" ><i style="font-size:20px" class="fa">&#xf01e;</i></a>
  <a class="w3-bar-item w3-button w3-teal" title="Testar" onclick="submitTryit(1);snhb.startAuction(['try_it_leaderboard']);"><i style="font-size:20px" class="fa">&#xf144;</i></a></div>
 </div> 
